...
const config = {
  api: {
    host: 'http://localhost', // ex: 'https://explorer.kabberry.com' for nginx (SSL), 'http://IP_ADDRESS' 
  ...
  coinDetails: {
    ...
    shortName: 'KKC',
    displayDecimals: 2,
    longName: 'Kabberry Cryptocurrency',
  ...
  social: [
    {
      ...
      options: {
        subreddit: 'kabberry_project', // Name of your subreddit
  ...
  community: {
    ...
    governanceAddresses: [
      ...
      /*
      // 72000 KKC 159ff849ae833c3abd05a7b36c5ecc7c4a808a8f1ef292dad0b02875009e009e
      "bZ1HJB1kEb1KFcVA42viGJPM7896rsRp9x",

      // 72000 KKC d35ed6e32886c108165c50235225da29ea3432404a4578831a8120b803e23f3d
      "bSP75eHtokmNq5n8iDVLbZVKuLAi8rN1KM",

      // 70000 KKC 5b3b0eec9271297a37c97fca1ecd98e033ea3813d8669346bfac0f08aa3142f8
      "bQockBvNDLUJ4zFV3g2EsymfuVxduWPpmA",

      // 45000 KKC 6a9fbf985e8d1737c3282d34759748ca02ab9c7893bd6d24dd5d72db66325707
      // 37000 KKC 3c1f46128606ddca07a4691f8697974c8789ca365c6f3ac8e7d866740450cb59
      "bR1Qa5HjuU8bN3J2WqrM2FSWzmk7RPyujp",

      // 25000 KKC 8ab5e85f2863afa1fdab187a2747d492a0d2a3903038063dbd5e187a76efdb03
      // 25000 KKC 98d82c3e6fd371daeaee45ed56875c413c5a6f596571fdb8888e8bf23b3e530c
      "bUagNLYEPmDTbnr7QgqFJidnASxvjNp2Kh",

      // 20000 KKC c86852e84b0c8d31af953ad75c42a6f581f8f2bb6f8835e7e9080694f92151c8
      // 20000 KKC 78bb316c7d66067df8d279a74c619aaac4b5412066ef0b87b9b6765960895ade
      // 50 KKC 22bc15f46408eeafe4b2ac6f54ddbb9c3b277848a44ae4db2da7100dda2da1ec
      "bVnzUZen6Sn473trmkd5vJ3zVMW8HwtnT9",

      // 16500 KKC 2fc3878768ff97cb67d8336a7e6fef50dab71696f9c5fe33d4b6226468609efe
      // 16500 KKC 9f011213e8b6890ab1ec66f037f1e16f3c8c138289877e0572b498aef31b3020
      // 16500 KKC ac562d3f239b2896d293b3126e83bbf6bef618ce59194657668b1b049dd094ad
  ...
  addressWidgets: {
    ...
    'MN': {
      ...
      carverAddressLabelWidget: {
        ...
        title: 'Each block contains a small portion that is awarded to masternode operators that lock 5000 KKC. Masternodes contribute to the network by handling certain coin operations within the network.'
      }
    },
    'POW': {
      // Adds a new label metadata address
      carverAddressLabelWidget: {
        ...
        title: 'Kabberry started as a Proof Of Work & Masternode coin. Blocks would be mined by powerful computers and be rewarded for keeping up the network.'
      }
    },
    'POS': {
      // Adds a new label metadata address
      carverAddressLabelWidget: {
        ...
        title: 'Inputs that are over 100 KKC can participate in network upkeep. Each block (~90 seconds) one of these inputs is rewarded for keeping up the network.'
      }
    },
  },
   ...
   * Cron & Syncing
   */
  blockConfirmations: 2,           // We will re-check block "merkleroot" this many blocks back. If they differ we will then start unwinding carver movements one block at a time until correct block is found. (This is like min confirmations)
