...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="https://kabberry.com/">
        <img src="#" title="Kabberry Crypto"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>Kabberry Explorer is not available at this moment.<br/>Please check back later.</p><br/>
  <a href="https://kabberry.com/" class="button">Back to Main</a>
      </div>
  </body>
</html>
  `);
